document.addEventListener("DOMContentLoaded", function () {
  const navHTML = `
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="../html/index.html">Eli</a>
      </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="../html/projects/visual.html">Animation</a></li>
          ...
          <li><a href="workinprogress.html"><span style="color: #656466;">NXT</span></a></li>
        </ul>
      </div>
    </div>
  `;
  ...
  links.forEach(link => {
    ...
    if (normalizePath(href) === currentPath) {
      ...
      if (li) {
        li.classList.add("active"); // Highlight only exact link
      }
    }
  });
});
